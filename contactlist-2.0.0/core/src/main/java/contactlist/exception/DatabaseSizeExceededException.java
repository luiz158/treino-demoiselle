...
public class DatabaseSizeExceededException extends RuntimeException {
	...
	public DatabaseSizeExceededException(ResourceBundle bundle, final long max) {
		this.bundle = bundle;
		this.max = max;
	}
	...
	public String getMessage() {
		return bundle.getString("max.register.quantity", String.valueOf(this.max));
	}
}
