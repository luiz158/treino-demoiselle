...
@ApplicationException(rollback = true, severity = SeverityType.WARN)
public class DuplicatedCpfException extends RuntimeException {
	...
	public DuplicatedCpfException(String cpf, ResourceBundle bundle) {
		this.cpf = cpf;
		this.bundle = bundle;
	}
	...
	public String getMessage() {
		return bundle.getString("duplicated.cpf.number", cpf);
	}
}