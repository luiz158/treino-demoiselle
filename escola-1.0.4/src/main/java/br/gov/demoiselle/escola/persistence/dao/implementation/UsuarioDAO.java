...
import br.gov.demoiselle.escola.persistence.dao.filter.FiltroUsuario;
import br.gov.frameworkdemoiselle.pagination.Page;
import br.gov.frameworkdemoiselle.pagination.PagedResult;

public class UsuarioDAO extends HibernateFilterGenericDAO<Usuario> implements IUsuarioDAO{
