 ...
 */ 
package br.gov.sample.demoiselle.escola.view.listener;
...
public class MensagemListener implements PhaseListener {

	private static final long serialVersionUID = 1L;

	/**
	 * Adicionar todas as mensagens no contexto de mensagem.
	 * Ao final limpa o contexto de mensagens.
	 */
