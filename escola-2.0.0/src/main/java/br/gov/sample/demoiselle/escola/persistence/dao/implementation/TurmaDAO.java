...
import br.gov.sample.demoiselle.escola.persistence.dao.filter.FiltroTurma;

public class TurmaDAO extends HibernateFilterGenericDAO<Turma> implements
		ITurmaDAO {
	...
	public Turma buscar(Turma turma) {
		...
		f.addEquals(FiltroTurma.ID, turma.getId());
