...
public class Audit implements Serializable {
	...
	public Audit(String cpf, String messageKey) {
		this.message = BundleUtil.getCore().getString(messageKey) + cpf;
	}
	
	public Audit(Long id, String messageKey) {
		this.message = BundleUtil.getCore().getString(messageKey) + id;
	}
